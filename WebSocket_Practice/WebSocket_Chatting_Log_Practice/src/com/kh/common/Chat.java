...
public class Chat {
	...
	private ChatSession getSession(Session userSession) {
		// session 클래스와 ChatSession 클래스의 session 변수를 비교해서 탐색
	...
	// 브라우저로부터 메세지가 오면 호출되는 함수
	@OnMessage
	public void handleMessage(String message, Session userSession) {
		// 메세지 JSON 타입으로 와서 ChatMessage 클래스로 변환
