...
CREATE TABLE EVENT (
    ...
    CONSTRAINT EVT_ISDELETE_CHK CHECK (ISDELETE IN('Y', 'N'))
);
...
COMMENT ON COLUMN EVENT.ISDELETE IS '삭제여부';
...
CREATE TABLE CALENDAR (
    ...
    ISDELETE CHAR(1) DEFAULT 'N',
    CONSTRAINT CAL_ISDELETE_CHK CHECK (ISDELETE IN('Y', 'N'))
);
...
CREATE TABLE EVT_CAL_REGISTRATION (
    ...
    CAL_NO NUMBER,
    EVT_NO NUMBER,
    CONSTRAINT EVT_CAL_CAL_FK FOREIGN KEY(CAL_NO) REFERENCES CALENDAR(CAL_NO) ON DELETE CASCADE,
    --CONSTRAINT EVT_CAL_EVT_FK FOREIGN KEY(EVT_NO) REFERENCES EVENT(EVT_NO) ON DELETE CASCADE
);

ALTER TABLE EVT_CAL_REGISTRATION ADD CONSTRAINT EVT_CAL_EVT_FK FOREIGN KEY(EVT_NO) REFERENCES EVENT(EVT_NO) ON DELETE CASCADE;
...
ALTER TABLE CAL_REGISTRATION ADD CONSTRAINT CAL_REG_CAL_FK FOREIGN KEY(CAL_NO) REFERENCES CALENDAR(CAL_NO) ON DELETE CASCADE;
...
ALTER TABLE ATTENDANT ADD CONSTRAINT ATT_EVT_FK FOREIGN KEY(EVT_NO) REFERENCES EVENT(EVT_NO) ON DELETE CASCADE;
...
-- ATTENDANT
-- EVT_CATEGORY
CREATE SEQUENCE SEQ_CAL START WITH 2 NOCACHE;
CREATE SEQUENCE SEQ_CAL_REG START WITH 2 NOCACHE;
CREATE SEQUENCE SEQ_LIKE_CAL_REG START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_EVT_CAL_REG START WITH 6 NOCACHE;
CREATE SEQUENCE SEQ_EVT START WITH 10 NOCACHE;
CREATE SEQUENCE SEQ_ATT START WITH 7 NOCACHE;
CREATE SEQUENCE SEQ_EVT_CAT START WITH 4 NOCACHE;
...
-- AL_INFORMATION
-- INFO_ATTACHMENT
CREATE SEQUENCE SEQ_REZ START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_AS START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_AL START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_REZ_INFO START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_AL_USG_INFO START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_AL_INFO START WITH 1 NOCACHE;
CREATE SEQUENCE SEQ_AL_INFO_ATT START WITH 1 NOCACHE;
...
WHERE EMP_NO = 201 AND ISDELETE = 'N';
...
SELECT LAST_NUMBER 
FROM USER_SEQUENCES 
WHERE SEQUENCE_NAME = 'SEQ_EVT_CAL_REG';
...
SELECT LAST_NUMBER 
FROM USER_SEQUENCES 
WHERE SEQUENCE_NAME = 'SEQ_CAL_REG';


-- CREATE ----------------------------------------------------------------------
-- CALENDAR 
INSERT INTO CALENDAR VALUES(SEQ_CAL.NEXTVAL, '기본 캘린더', DEFAULT);
COMMIT;

---- EVT_CAL_REGISTATION
INSERT INTO EVT_CAL_REGISTRATION VALUES(SEQ_EVT_CAL_REG.NEXTVAL, 1, 2);
INSERT INTO EVT_CAL_REGISTRATION VALUES(SEQ_EVT_CAL_REG.NEXTVAL, 1, 1);
INSERT INTO EVT_CAL_REGISTRATION VALUES(SEQ_EVT_CAL_REG.NEXTVAL, 1, 3);
INSERT INTO EVT_CAL_REGISTRATION VALUES(SEQ_EVT_CAL_REG.NEXTVAL, 1, 4);
...
-- EVENT
-- insertEvent --
INSERT INTO EVENT VALUES(SEQ_EVT.NEXTVAL, '이벤트1', SYSDATE, SYSDATE, '이벤트장소1', '이벤트내용1', 1, DEFAULT);
INSERT INTO EVENT VALUES(SEQ_EVT.NEXTVAL, '이벤트2', SYSDATE + 1, SYSDATE + 3, '이벤트장소2', '이벤트내용2', 1, DEFAULT);
INSERT INTO EVENT VALUES(SEQ_EVT.NEXTVAL, '이벤트3', SYSDATE + 2, SYSDATE + 4, '이벤트장소3', '이벤트내용3', 1, DEFAULT);
INSERT INTO EVENT VALUES(SEQ_EVT.NEXTVAL, '이벤트4', SYSDATE + 11, SYSDATE + 14, '이벤트장소4', '이벤트내용4', 1, DEFAULT);
COMMIT;

---- ATTENDANT
-- 201 kth
-- insertAttendant --
INSERT INTO ATTENDANT VALUES(SEQ_ATT.NEXTVAL, 1, 201);
INSERT INTO ATTENDANT VALUES(SEQ_ATT.NEXTVAL, 2, 201);
INSERT INTO ATTENDANT VALUES(SEQ_ATT.NEXTVAL, 3, 201);
INSERT INTO ATTENDANT VALUES(SEQ_ATT.NEXTVAL, 1, 202);
INSERT INTO ATTENDANT VALUES(SEQ_ATT.NEXTVAL, 4, 202);
COMMIT;
...
-- DELETE ----------------------------------------------------------------------
-- CALENDAR 
UPDATE CALENDAR SET ISDELETE = 'Y' WHERE CAL_NO = 4;

-- EVENT
UPDATE EVENT SET ISDELETE = 'Y' WHERE EVT_NO = 11;

-- ATTENDANT 
DELETE FROM ATTENDNAT WHERE EVT_NO = 1;

COMMIT;

---- TRIGGER
-- Delete 안쓰기로 함
CREATE OR REPLACE TRIGGER TR_EVT_ATT_DELETE
AFTER DELETE ON EVENT
FOR EACH ROW
BEGIN
    DELETE FROM ATTENDANT WHERE EVT_NO = :OLD.EVT_NO;
END TR_EVT_ATT_DELETE;
/

CREATE OR REPLACE TRIGGER TR_EVT_EVT_CAL_REG_DELETE
AFTER DELETE ON EVENT
FOR EACH ROW
BEGIN
    DELETE FROM EVT_CAL_REGISTRATION WHERE EVT_NO = :OLD.EVT_NO;
END TR_EVT_EVT_CAL_REG_DELETE;
/
